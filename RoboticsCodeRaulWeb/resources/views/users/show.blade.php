                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="first_name" class="form-control @error('first_name') is-invalid @enderror" 
                                                           value="{{ old('first_name', $user->first_name) }}" @readonly(true) @disable(true)>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="last_name" class="form-control @error('last_name') is-invalid @enderror" 
                                                           value="{{ old('last_name', $user->last_name) }}" @readonly(true) @disable(true)>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="schoolnumber" class="form-control @error('schoolnumber') is-invalid @enderror" 
                                                           value="{{ old('schoolnumber', $user->schoolnumber) }}" @readonly(true) @disable(true)>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" name="birth_date" class="form-control @error('birth_date') is-invalid @enderror" 
                                                           value="{{ old('birth_date', $user->birth_date) }}" @readonly(true) @disable(true)>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" 
                                                           value="{{ old('email', $user->email) }}" @readonly(true) @disable(true)>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="tel" name="phonenumber" class="form-control @error('phonenumber') is-invalid @enderror" 
                                                           value="{{ old('phonenumber', $user->phonenumber) }}" @readonly(true) @disable(true)>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="tshirt_size" class="form-control @error('tshirt_size') is-invalid @enderror" 
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="form-check me-3">
                                                            <input class="form-check-input" type="radio" name="image_authorization"
                                                                   ...
                                                                   @checked(old('image_authorization', $user->image_authorization) === 'sim')  @readonly(true) @disable(true)>
                                                            <label class="form-check-label" for="authSim">Sim</label>
                                                        </div>
                                                        <div class="form-check me-3">
                                                            <input class="form-check-input" type="radio" name="image_authorization"
                                                                   id="authNao" value="nao"
                                                                   @checked(old('image_authorization', $user->image_authorization) === 'nao')  @readonly(true) @disable(true)>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="form-check me-3">
                                                            <input class="form-check-input" type="radio" name="food_allergies" id="alergiasSim" 
                                                                   value="sim" {{ old('food_allergies', $user->food_allergies) === 'sim' ? 'checked' : '' }}  @readonly(true) @disable(true)>
                                                        ...
                                                        <div class="form-check me-3">
                                                            <input class="form-check-input" type="radio" name="food_allergies" id="alergiasNao" 
                                                                   value="nao" {{ old('food_allergies', $user->food_allergies) === 'nao' ? 'checked' : '' }}  @readonly(true) @disable(true)>
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea  class="form-control @error('allergies_description') is-invalid @enderror" 
                                                              name="allergies_description" rows="3"  @readonly(true) @disable(true)>{{ old('allergies_description', $user->allergies_description) }}</textarea>
                                                </div>
                                            </div>
                                        </div>
