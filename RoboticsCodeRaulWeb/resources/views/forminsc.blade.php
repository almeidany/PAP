...
<body>
    ...
    <div class="container">
        <form method="post" action="">
            ...
            <h2 class="my-4">Experiência e Conhecimentos</h2>
            <div class="row mb-3">
                <div class="col-6">
                    <label>Já participaste de um clube de robótica?</label>
                    <div class="d-flex align-items-center">
                        <div class="form-check me-3">
                            <input class="form-check-input" type="radio" id="participouSim" name="participou"
                                value="sim" required>
                            <label class="form-check-label" for="participouSim">Sim</label>
                        </div>
                        <div class="form-check me-3">
                            <input class="form-check-input" type="radio" id="participouNao" name="participou"
                                value="nao" required>
                            <label class="form-check-label" for="participouNao">Não</label>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    <label>Eu considero as minhas habilidades de programação:</label>
                    <div class="d-flex align-items-center">
                        <div class="form-check me-3">
                            <input class="form-check-input" type="radio" id="habilidadesBoas" name="habilidades"
                                value="boas" required>
                            <label class="form-check-label" for="habilidadesBoas">Boas</label>
                        </div>
                        <div class="form-check me-3">
                            <input class="form-check-input" type="radio" id="habilidadesMedia" name="habilidades"
                                value="media" required>
                            <label class="form-check-label" for="habilidadesMedia">Média</label>
                        </div>
                        <div class="form-check me-3">
                            <input class="form-check-input" type="radio" id="habilidadesDesenvolver"
                                name="habilidades" value="desenvolver" required>
                            <label class="form-check-label" for="habilidadesDesenvolver">Gostaria de me desenvolver
                                mais nesse ramo</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-6">
                    <label>Tem interesse em eletrónica?</label>
                    <div class="d-flex align-items-center">
                        <div class="form-check me-3">
                            <input class="form-check-input" type="radio" id="interesseSim" name="interesse"
                                value="sim" required>
                            <label class="form-check-label" for="interesseSim">Sim</label>
                        </div>
                        <div class="form-check me-3">
                            <input class="form-check-input" type="radio" id="interesseNao" name="interesse"
                                value="nao" required>
                            <label class="form-check-label" for="interesseNao">Não</label>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    <label>Você já trabalhou em algum projeto de robótica?</label>
                    <div class="d-flex align-items-center">
                        <div class="form-check me-3">
                            <input class="form-check-input" type="radio" id="projetoSim" name="projeto"
                                value="sim" required>
                            <label class="form-check-label" for="projetoSim">Sim</label>
                        </div>
                        <div class="form-check me-3">
                            <input class="form-check-input" type="radio" id="projetoNao" name="projeto"
                                value="nao" required>
                            <label class="form-check-label" for="projetoNao">Não</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-6">
                    <label>Tem experiência com design e impressão 3D?</label>
                    <div class="d-flex align-items-center">
                        <div class="form-check me-3">
                            <input class="form-check-input" type="radio" id="designSim" name="design"
                                value="sim" required>
                            <label class="form-check-label" for="designSim">Sim, ALGUMA</label>
                        </div>
                        <div class="form-check me-3">
                            <input class="form-check-input" type="radio" id="designNao" name="design"
                                value="nao" required>
                            <label class="form-check-label" for="designNao">Não</label>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    <label>Tem experiência em trabalho em equipa?</label>
                    <div class="d-flex align-items-center">
                        <div class="form-check me-3">
                            <input class="form-check-input" type="radio" id="equipeSim" name="equipe"
                                value="sim" required>
                            <label class="form-check-label" for="equipeSim">Sim</label>
                        </div>
                        <div class="form-check me-3">
                            <input class="form-check-input" type="radio" id="equipeNao" name="equipe"
                                value="nao" required>
                            <label class="form-check-label" for="equipeNao">Não</label>
                        </div>
                    </div>
                </div>
            </div>

            <h2 class="my-4">Parte Social Emocional</h2>
            <div class="mb-3">
                <label for="comunicacao" class="form-label">Qual a importância da comunicação aberta num
                    clube?</label>
                <textarea class="form-control" id="comunicacao" rows="3" required></textarea>
            </div>
            <div class="mb-3">
                <label for="conflitos" class="form-label">Como lidas com conflitos dentro da equipa?</label>
                <textarea class="form-control" id="conflitos" rows="3" required></textarea>
            </div>
            <div class="mb-3">
                <label for="beneficio" class="form-label">Indique-nos um benefício de trabalhar em
                    equipa</label>
                <textarea class="form-control" id="beneficio" rows="3" required></textarea>
            </div>
            <div class="mb-3">
                <label for="ambiente" class="form-label">O que promove um bom ambiente de trabalho positivo
                    numa
                    equipa?</label>
                <textarea class="form-control" id="ambiente" rows="3" required></textarea>
            </div>

            <div class="row mb-3">
                <div class="col-12 text-center">
                    <button type="reset" class="btn btn-secondary">Limpar</button>
                    <button type="submit" class="btn btn-primary" id="subbtn">Submeter</button>
                </div>
            </div>
        </form>
    </div>
