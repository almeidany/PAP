                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="form-check me-3">
                                                    <input class="form-check-input" type="radio" id="alergiasSim" name="food_allergies" 
                                                           value="sim" @checked(old('food_allergies') == 'sim')>
                                                    <label class="form-check-label" for="alergiasSim">Sim</label>
                                                </div>
                                                <div class="form-check me-3">
                                                    <input class="form-check-input" type="radio" id="alergiasNao" name="food_allergies" 
                                                           value="nao" @checked(old('food_allergies', 'nao') == 'nao')>
                                                    <label class="form-check-label" for="alergiasNao">Não</label>
                                                </div>
                                                <div class="form-check me-3">
                                                    <input class="form-check-input" type="radio" id="alergiasOutros" name="food_allergies" 
                                                           value="outros" @checked(old('food_allergies') == 'outros')>
                                                    <label class="form-check-label" for="alergiasOutros">Outros</label>
                                                </div>
                                            </div>
                                            <input type="text" name="allergies_description" class="form-control mt-2 @error('allergies_description') is-invalid @enderror" 
                                                   id="alergiasOutrosDescricao" placeholder="Descreva suas alergias alimentares" 
                                                   value="{{ old('allergies_description') }}" style="display: {{ old('food_allergies') == 'outros' ? 'block' : 'none' }};">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="form-check me-3">
                                                    <input class="form-check-input" type="radio" id="autorizacaoSim" name="image_authorization" 
                                                           value="sim" @checked(old('image_authorization') == 'sim') required>
                                                    <label class="form-check-label" for="autorizacaoSim">Sim</label>
                                                </div>
                                                <div class="form-check me-3">
                                                    <input class="form-check-input" type="radio" id="autorizacaoNao" name="image_authorization" 
                                                           value="nao" @checked(old('image_authorization') == 'nao') required>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">Se necessário, escreva-as aqui</label>
                                            <textarea class="form-control @error('otheralergies') is-invalid @enderror" name="otheralergies" 
                                                      rows="3">{{ old('otheralergies') }}</textarea>
                                            @error('otheralergies')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" class="form-control @error('profile_photo') is-invalid @enderror" 
                                                   name="profile_photo" id="FotodePerfil">
                                            @error('profile_photo')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
