    ...
    <div class="news-grid">
        ...
        <div class="news-card">
            <div class="news-card-header">
                @if($item->photo)
                <img src="{{ asset('storage/images/news/'.$item->photo) }}" alt="Notícia" class="news-image">
                @else
            ...
            <div class="news-card-footer" style="justify-content: center; ">
                <a href="{{ route('news.edit', $item->id) }}" class="btn btn-sm btn-outline-primary" title="Editar">
                    <i class="bi bi-pencil"></i>
                </a>
                <a href="{{ route('news.show', $item->id) }}" class="btn btn-sm btn-outline-secondary" title="Ver Notícia Completa" target="_blank">
                    <i class="bi bi-eye"></i>
                </a>
                <form action="{{ route('news.destroy', $item->id) }}" method="POST" class="d-inline">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="btn btn-sm btn-outline-danger" title="Apagar" onclick="return confirm('Tem certeza que deseja apagar esta notícia?')">
