            ...
            <nav class="navbar navbar-expand-lg navbar-dark p-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <a href="Concursos.html" class="nav-item nav-link">Concursos</a>
                        <!--<a href="projetos.html" class="nav-item nav-link active">Projetos</a>-->
                        <a href="galeria.html" class="nav-item nav-link">Galeria</a>
                        <a href="sobrenos.html" class="nav-item nav-link">Sobre Nós</a>
                        <a href="forminsc.html" class="nav-item nav-link">Formulário de Inscrição</a>
                    </div>
                </div>
            </nav>
        </div>
