                                ...
                                <table id="attendances_table" class="table table-striped table-bordered text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-0">
                                                <form id="deleteAttendance{{ $attendance->id }}" action="{{ route('attendance.destroy', $attendance->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Tem certeza que deseja excluir esta presença?')">
